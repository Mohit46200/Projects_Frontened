      ...
      <div className="bg-[#faf7f5] min-h-screen py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-14 text-center">
            <span className="uppercase tracking-[0.3em] text-xs text-[#7b2140]">Curated Collection</span>
            <h1 className="mt-4 text-4xl md:text-5xl font-serif text-gray-900">Discover Beautiful Plants</h1>
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Handpicked indoor and outdoor plants designed to bring freshness, calmness, positivity and elegance into your space.
            </p>
  ...
  return (
    <div className="bg-[#faf7f5] min-h-screen py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {plant.map((p, index) => {
            const isAdded = userCartData?.product_id?.includes(p.product_id) || addedItems[p.product_id]
            const isAdding = addingItem === p.product_id
              ...
              >
                ...
                <div className="p-7">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <h2 className="text-2xl font-serif text-gray-900 leading-snug">{p.name}</h2>
                  ...
                  <div className="mt-8 flex gap-3">
                    ...
                    <motion.button
                      ...
                      onClick={async () => {
                        ...
                        await addcart(p.product_id)
                        setClickedonAddtoCart(true)

                        if (login) {
                          setAddedItems((prev) => ({ ...prev, [p.product_id]: true }))
                        }
                      }}
                    >
                      {isAdding ? (
